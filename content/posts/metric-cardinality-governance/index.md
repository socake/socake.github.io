...
这篇文章是那之后的经验总结。读完你应该能回答：

1. 什么是 cardinality，为什么它是 Prometheus 生态的头号杀手？
2. 怎么发现 cardinality 问题？
3. 发生之后怎么灭火？
4. 怎么建立长期治理机制？
...
我们花了 6 个月把基数从 8 亿降到 5 亿（同时业务增长 30%），靠的不是什么神奇算法，就是把上面这些流程一条条落地。结果：对象存储成本降 30%，查询 p99 降 50%，ingester 内存占用降 40%。

希望这篇文章能让你在下一次被高基数告警叫醒之前，就把治理机制跑起来。预防永远比灭火便宜。
